...
Additional features in the [pro version](http://zatzlabs.com/better-recent-posts-widget/):
...
1. Upload the 'recent-posts-widget' folder to the `/wp-content/plugins/` directory
...
= 1.1.11 =
* Minor update for support changes

= 1.1.10 =

* Minor update for WordPress 4.4.2 compatibility
